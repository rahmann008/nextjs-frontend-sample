...
import ContentHubsLatestPost from '../../../components/Media/ContentHubs/ContentHubsLatestPost';
  ...
  return (
    <>
      <CoverImage
        headerSmall="Media"
        header="Content Hub"
        coverImage="/img/media/content-hubs/content-hub-header.png"
      />
      <Banner
        subpage={['Media', 'Content Hub']}
        href={['/media', '/media/content-hubs']}
      />
      <div className="flex flex-col px-8 sm:px-10 xl:px-12">
        <div className="flex flex-col mt-20 mb-10 md:mb-0">
          <div>
            ...
            <div className="mb-6 text-base lg:text-lg xl:text-xl font-mulish-semibold">
              Browse through our articles and podcast lorempisum nec viverra
              eleifend lacus, vitae sit amet blandit dolor
            </div>
          </div>
          <div className="flex flex-col sm:flex-row z-30">
            ...
            <div className="flex flex-col justify-center">
              <Menu as="div" className="relative inline-block text-left">
                <div>
                  <MenuButton title="Media Type:" value={type} />
                </div>
                <Transition
                  as={Fragment}
                  enter="transition ease-out duration-100"
            ...
            <div className="flex flex-col justify-center">
              <Menu as="div" className="relative inline-block text-left">
                <div>
                  <MenuButton title="Topic:" value={topic} />
                </div>
                <Transition
                  as={Fragment}
                  enter="transition ease-out duration-100"
                ...
                >
                  <Menu.Items className="origin-top-right absolute left-0 w-44 lg:w-60 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div className="py-1">
                      ...
                      />
                      <DropdownSelection
                        selection="LIFE@edotco"
                        onClick={() => setTopic('LIFE@edotco')}
                      />
                      <DropdownSelection
                      ...
                      <DropdownSelection
                        ...
                        onClick={() => setTopic('Innovation')}
                      />
                      <DropdownSelection
                        selection="Sustainability"
                        onClick={() => setTopic('Sustainability')}
                      />
                      <DropdownSelection
                        selection="Success Stories"
                        onClick={() => setTopic('Success Stories')}
                      />
                      <DropdownSelection
                        selection="Human Resource"
                        onClick={() => setTopic('Human Resource')}
                      />
                    </div>
                  </Menu.Items>
                </Transition>
      ...
      <RelatedMedia
        ...
        tileHref={['/media/media-releases', '/media/reports']}
        tileImage={[
